...
public class CILogonServlet extends HttpServlet {
   private static final long serialVersionUID = 1L;
   private static final String REDIRECT_URI = "https://falco.ncsa.uiuc.edu/cilogon/";
   private static final String USERINFO_URI = "https://cilogon.org/oauth2/userinfo";
   private static final String AUTHZ_URI = "https://cilogon.org/authorize";
   private static final String TOKEN_URI = "https://cilogon.org/oauth2/token";
 ...
 public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    if (get_error != null && !get_error.isEmpty()) {
      ...
      String authUrl = new AuthorizationRequestUrl(
        ...
        .setScopes(Arrays.asList("profile", "email", "openid", "org.cilogon.userinfo"))
        .build();
      out.println("<a href=" + authUrl + ">Log on with CILogon</a>");
      ...
      try {
        ...
        out.println("<pre>" + gson.toJson(parser.parse(callAPIMethod(USERINFO_URI, tokenresponse.getAccessToken()))) + "</pre>");
        out.println("<p><a target=\"_blank\" href=\"https://registry-test.cilogon.org/registry/co_petitions/start/coef:29\">1. Join the CILogon CO (Collaborative Organization).</a></p>");
        out.println("<p><a target=\"_blank\" href=\"https://registry-test.cilogon.org/registry/co_petitions/start/coef:119\">2. Join the 'authenticated' group.</a></p>");
        out.println("<p><a href=\"https://falco.ncsa.uiuc.edu/cilogon\">Log on again.</a></p>");
