...
public class GlobusServlet extends HttpServlet {
   private static final long serialVersionUID = 1L;
   private static final String REDIRECT_URI = "https://falco.ncsa.uiuc.edu/globus/";
   private static final String USERINFO_URI = "https://auth.globus.org/v2/oauth2/userinfo";
   private static final String AUTHZ_URI = "https://auth.globus.org/v2/oauth2/authorize";
   private static final String TOKEN_URI = "https://auth.globus.org/v2/oauth2/token";
 ...
 public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    if (get_error != null && !get_error.isEmpty()) {
      ...
      String authUrl = new AuthorizationRequestUrl(
        ...
        .build();
      out.println("<a href=" + authUrl + ">Log In</a>");
